...
useEffect(() => {
  ...
  const NAV = [
    ...
    { icon:'ti-bell', label:'Notifications', path:'/facilities' },
    { icon:'ti-settings', label:'Settings', path:'/facilities' },
  ];
  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', fontFamily:"'Segoe UI',sans-serif", background:'#f5f6f8', position:'relative' }}>
      ...
      <div style={{ flex:1, display:'flex', position:'relative', zIndex:5 }}>
        ...
        <div style={{ flex:1, padding:'24px 22px', display:'flex', flexDirection:'column', gap:'16px', overflowY:'auto' }}>
          <div>
            <p style={{ color:'#00b85e', fontSize:'10px', letterSpacing:'2.5px', textTransform:'uppercase', margin:'0 0 5px', fontWeight:'600' }}>St Mary's University · Facilities Analytics</p>
            <h1 style={{ color:'#111827', fontSize:'20px', fontWeight:'700', margin:0, letterSpacing:'-0.4px' }}>Performance Overview</h1>
          </div>
        ...
        <div style={{ width:'230px', background:'#1c2e22', padding:'24px 20px', display:'flex', flexDirection:'column', gap:0, flexShrink:0, overflowY:'auto' }}>
