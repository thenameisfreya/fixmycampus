    ...
    <div style={{
      ...
      <div style={{
        ...
        {[
          ...
          { icon: 'ti-plus', label: 'Report Issue', path: '/submit', active: false },
          { icon: 'ti-list-check', label: 'My Reports', path: '/dashboard', active: false, badge: issues.length },
          { icon: 'ti-bell', label: 'Notifications', path: '/dashboard', active: false },
          { icon: 'ti-chart-bar', label: 'Analytics', path: '/analytics', active: false },
          { icon: 'ti-book', label: 'Help', path: '/dashboard', active: false }
        ].map((item, index) => (
          <div
            key={index}
            ...
            style={{
              ...
              gap: '10px',
              cursor: 'pointer',
              background: item.active ? 'rgba(0,232,122,0.12)' : 'transparent',
              border: item.active ? '1px solid rgba(0,232,122,0.25)' : '1px solid transparent',
          ...
          >
            <i
              ...
              style={{ fontSize: '16px', color: item.active ? '#00e87a' : 'rgba(255,255,255,0.35)' }}
              aria-hidden="true"
            />
            <span style={{
              fontSize: '12px',
              color: item.active ? '#00e87a' : 'rgba(255,255,255,0.35)',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <p style={{ color: '#fff', fontSize: '11px', fontWeight: '500', margin: 0 }}>
            ...
            <i
              ...
              style={{ fontSize: '14px', color: 'rgba(255,255,255,0.2)', marginLeft: 'auto', cursor: 'pointer' }}
              aria-hidden="true"
            />
          </div>
        </div>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '6px',
                boxShadow: '0 4px 15px rgba(0,184,94,0.3)',
                transition: 'all 0.2s ease'
              }}
              onMouseEnter={e => {
                e.currentTarget.style.transform = 'translateY(-1px)';
                e.currentTarget.style.boxShadow = '0 6px 20px rgba(0,184,94,0.4)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 15px rgba(0,184,94,0.3)';
              }}
            >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h2 style={{ color: '#1a1a2e', fontSize: '14px', fontWeight: '700', margin: 0 }}>
                  My Reports
                </h2>
                  ...
                  {filters.map(f => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '20px',
                        border: 'none',
                        background: filter === f ? '#1a1a2e' : 'rgba(0,0,0,0.06)',
                ...
                filteredIssues.map((issue, index) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: '14px 20px',
                        borderBottom: index < filteredIssues.length - 1
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ minWidth: 0 }}>
                          ...
                          <p style={{ color: '#9ca3af', fontSize: '11px', margin: 0 }}>
                            ...
                            {issue.location.room ? ' · Room ' + issue.location.room : ''}
                            {' · ' + issue.category}
                          </p>
                        </div>
                      </div>
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', width: '80px', height: '80px', margin: '0 auto 12px' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#1a1a2e', fontSize: '16px', fontWeight: '800' }}>
                      {resolutionPct}%
                    </span>
                  </div>
                </div>
                ...
                {[
                  ...
                  <div key={i} style={{ marginBottom: i < 2 ? '10px' : 0 }}>
                    ...
                    <div style={{ height: '4px', background: p.bg, borderRadius: '4px', overflow: 'hidden' }}>
                      <div style={{
                        height: '100%',
                        width: issues.length > 0 ? ((p.value / issues.length) * 100) + '%' : '0%',
                        background: p.color,
                        borderRadius: '4px',
